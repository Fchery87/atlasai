...
function EditorPanel() {
  ...
  return (
    <Card className="h-full flex flex-col bg-background">
      <CardHeader className="justify-between bg-muted/30">
  ...
  if (!staged) {
    return (
      <Card className="h-full flex flex-col bg-background shadow-sm">
        <CardHeader className="justify-between bg-muted/30">
          <CardTitle className="text-foreground/90">Diff</CardTitle>
        </CardHeader>
    ...
    <Card className="h-full flex flex-col bg-background">
      <CardHeader className="justify-between bg-muted/30">
        <div className="flex items-center justify-between w-full">
          <CardTitle className="text-foreground/90">Chat</CardTitle>
          {usageEstimate && (
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              ...
              <span title="Estimated cost" className="font-medium text-accent">
      ...
      <CardContent className="grow flex flex-col gap-3 p-3">
...
function PreviewPanel() {
  ...
  return (
    <Card className="h-full flex flex-col bg-background shadow-sm">
      <CardHeader className="justify-between bg-muted/30">
        <CardTitle className="text-foreground/90">Preview</CardTitle>
      </CardHeader>
      <CardContent className="grow p-0 bg-white">
        <iframe
          ref={iframeRef}
          title="Preview"
...
function TerminalPanel() {
  ...
  return (
    <Card className="h-full flex flex-col bg-background shadow-sm">
      <CardHeader className="justify-between bg-muted/30">
        <CardTitle className="text-foreground/90">Terminal</CardTitle>
      ...
      <CardContent className="grow bg-slate-950 p-3">
        <pre
          className="text-xs overflow-auto max-h-48 text-green-400 font-mono"
          aria-live="polite"
        >
          {lines.join("\n")}
        </pre>
    ...
    <div className="flex h-screen flex-col bg-background text-foreground overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-4 space-y-4">
          ...
          <section aria-label="Workbench" className="min-h-[600px]">
            <SplitPane
              dir="vertical"
              sizes={[26, 38, 36]}
